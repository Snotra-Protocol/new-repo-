...
const ExtendModal = ({ item, handleModal, open }) => {
  ...
  const removeItem = (item) => {
    ...
    localStorage.setItem("basketItemsBorrow", JSON.stringify(updateItem));
    setTimeout(() => {
      handleModal();
    }, 1000);
  };
      ...
      >
        <ModalContent>
          ...
          <Typography sx={{ textAlign: "center" }}>
            Extend your loan for 7 days more
          </Typography>
          <Box
            marginTop={1}
            sx={{
